...
$l['optawards_confirm_deleteaward'] = 'Willst du wirklich die Auszeichnung löschen?';
...
$l['optawards_award_pm_template'] = 'PM Vorlage<p>Du kannst MyBB-Code und diese Platzhalter verwenden:
</p>
Standardvorlage:<ul>
...
$l['optawards_confirm_deleteclass'] = 'Willst Du diese Auszeichnungsklasse wirklich löschen?';
...
$l['optawards_username_recipient'] = 'Gib den Benutzernamen des Empfängers ein, welcher die Auszeichnung verliehen/aberkannt werden soll.';
$l['optawards_reason_description'] = 'Gibt den Grund an, warum die Auszeichnung verliehen werden soll, es kann MyBB-Code verwendet werden:';
...
$l['optawards_deny_reason_description'] = 'Gib den Grund an, warum die Auszeichung angelehnt wird. Es kann MyBB-Code verwendet werden:';
...
$l['optawards_award_request_denied'] = 'Deine Auszeichungsanfrage wurde abgelehnt';
...
$l['optawards_pending_award_requests'] = 'Es gibt {awardrequests} offenen Anfragen für Auszeichnungen, für welche du zuständig bist, bitte bearbeiten!';
...
$l['optawards_pmicon_description'] = 'Wähle das PM Icon. -1 = kein Icon';
$l['optawards_pm_default_description'] = 'Du kannst MyBB-Code und diese Platzhalter verwenden:
</p>
Names:<ul>
<li>{recipient} - Name des Empfängers der Auszeichnung</li>
<li>{requestor} - Name des Antragstellers der Auszeichnung</li>
...
$l['optawards_pm_deny_description'] = 'Du kannst MyBB-Code und diese Platzhalter verwenden:
</p>
Names:<ul>
<li>{recipient} - Name des Empfängers der Auszeichnung</li>
<li>{requestor} - Name des Antragstellers der Auszeichnung</li>
...
Hiermit erhältst Du die Auszeichnung ''[url={awardinfo}]{award}[/url]''[font=Courier][size=x-small][1][/size][/font] Aufgrund folgender Verdienste:
[i]{reason}

{date}, {requestor}[/i]

Trage sie mit dem angemessenen Stolz!
[img]{icon}[/img]
...
$l['optawards_can_manage_awards'] = 'Kann die Auszeichnungen verwalten?';
